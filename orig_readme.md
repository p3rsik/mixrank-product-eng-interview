...
Please don't use AI tools to generate code, docs, or other content for this project. If you do, please limit it to certain files and disclose which files were generated so we don't spend time reviewing them. We're not against using AI tools in our work at MixRank, but it defeats the point of this interview assignment. You'll give a better impression if you write a small and incomplete program by hand than if you submit an awesome program that has traces of LLM output mixed throughout, especially if it is undisclosed.
